...
Third-year CSE undergrad at **IIT Goa** (CGPA: 8.48), building real systems at the intersection of AI, full-stack web, and distributed computing. I care about writing code that ships and scales — not just code that compiles.

- 🔭 Currently working on AI-powered platforms and secure networking systems
- ⚡ Competitive programmer — LeetCode **Knight** (1862) · Codeforces **Pupil** (1351)
- 🏅 Top 7 nationally at **Texas Instruments WiSE Hackathon**
- 🏃 Represented IIT Goa at **Inter-IIT Sports Meet** in Athletics
...
![Verilog](https://img.shields.io/badge/Verilog-FF6B6B?style=flat&logoColor=white)
